...
|---|---|---|---|
| `.github/workflows/orchestrator-agent.yml` | `workflow-orchestration-queue-india87` | A, D | **DONE** |
| `.github/workflows/prompts/orchestrator-agent-prompt.md` | `workflow-orchestration-queue-india87` | B, D | **DONE** |
| `.github/.labels.json` | `workflow-orchestration-queue-india87` | C, D, L | **DONE** |
